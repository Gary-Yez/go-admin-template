...
export const SysMenuApi = {
    ...
    Sort(form: { id:number; target_id:number; position:'before' | 'after' | 'inside'; source_parent_id:number | null; target_parent_id:number | null; source_ids:number[]; target_ids:number[] }) {
